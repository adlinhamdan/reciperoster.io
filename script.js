...
function toggleIngredientsCard() {
  ...
  ingredientsCard.classList.toggle('hidden');

  const button = document.querySelector('.toggle-ingredients-btn');
  if (ingredientsCard.classList.contains('hidden')) {
    button.textContent = 'View Ingredients';
  } else {
